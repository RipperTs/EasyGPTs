...
const nodeTypes: Record<FlowNodeTypeEnum, any> = {
  ...
  [FlowNodeTypeEnum.agentChat]: dynamic(() => import('./nodes/NodeTools')),
  ...
  [FlowNodeTypeEnum.timeSemanticParse]: NodeSimple,
  ...
  [FlowNodeTypeEnum.codeGenerator]: NodeSimple,
  [FlowNodeTypeEnum.codeInterpreter]: NodeSimple,
  ...
  [FlowNodeTypeEnum.terminateWorkflow]: NodeSimple
};
const edgeTypes = {
