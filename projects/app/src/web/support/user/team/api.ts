...
export const delDeleteTeam = (teamId: string) => {
  console.log('调用删除团队API', teamId);
  return DELETE(`/support/user/team/delete`, { teamId });
};
...
export const getTeamInvoiceHeader = () =>
  GET<TeamInvoiceHeaderType>(`/support/user/team/invoiceAccount/getTeamInvoiceHeader`);

export const updateTeamInvoiceHeader = (data: TeamInvoiceHeaderType) =>
  POST(`/support/user/team/invoiceAccount/update`, data);
